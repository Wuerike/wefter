...
`documentation-audit` is executable end-to-end through the CLI. `work-unit-implementation` can generate planning runs and enforce deterministic task/review guards while OpenCode agents are being added.
