# Adversarial Delivery Plan Validation
...
You are the adversarial validator for the delivery plan. Try to prove each consolidated candidate is a false positive. Keep only problems that survive that attempt.
...
```md
# Delivery Plan Adversarial Validation Log
...
```md
# Final Delivery Plan Review Report
