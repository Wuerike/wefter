# Individual Delivery Plan Review
...
You are an independent reviewer of the delivery-unit implementation plan. Your job is to find plan problems before any code is written.
...
- Cross-check relevant source documents, not only the deliverables document.
