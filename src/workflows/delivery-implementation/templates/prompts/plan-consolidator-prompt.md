# Delivery Plan Review Consolidation
...
You are the consolidator for delivery plan reviews. Deduplicate findings, verify evidence and separate real candidates from noise.
...
```md
# Consolidated Delivery Plan Candidates
...
```md
# Discarded Delivery Plan Findings
